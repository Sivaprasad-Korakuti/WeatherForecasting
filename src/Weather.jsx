    ...
    return (
        <div className="container">
            ...
            <div className="WeatherContainer">
                ...
                <div class="data">
                    <p className="cityName"><b>City: </b>{data && data.name ? data.name : ""} </p>
                    <h2>Weather Data:</h2>
                    ...
                    <p><b>Wind Speed: </b>{data && data.wind.speed ? (data.wind.speed) : ""}%</p>
                    <p><b>Humidity: </b>{data && data.main.humidity ? (data.main.humidity) : ""}%</p></div>
            </div>
        </div>
    )
}
